...
#Plotting Closing Price vs other continuous variables
...
Geo_Market_terms <- unique(Data2$GeoMarketArea)
print(Geo_Market_terms)

#Model 6: Selected variables from Lasso Regression Model vs Closing Price
model6 <- lm(ClosePrice ~ HOAMandatory + NewConstruction + SqFtTotal + PoolPrivate, data = Data2)
summary(model6)

#Nearly 58% of variability in the closing price was explained by the independent variables in this model.
